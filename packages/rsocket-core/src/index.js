...
import WellKnownMimeType, {
  APPLICATION_AVRO,
  APPLICATION_CBOR, APPLICATION_CLOUDEVENTS_JSON,
  APPLICATION_GRAPHQL,
  APPLICATION_GZIP, APPLICATION_HESSIAN, APPLICATION_JAVA_OBJECT,
  ...
  IMAGE_JPEG,
  IMAGE_PNG,
  IMAGE_TIFF, MESSAGE_RSOCKET_COMPOSITE_METADATA, MESSAGE_RSOCKET_ROUTING, MESSAGE_RSOCKET_TRACING_ZIPKIN,
  MULTIPART_MIXED,
  TEXT_CSS,
  TEXT_CSV, TEXT_HTML, TEXT_PLAIN, TEXT_XML,
  UNKNOWN_RESERVED_MIME_TYPE,
  UNPARSEABLE_MIME_TYPE, VIDEO_H264, VIDEO_H265, VIDEO_VP8
